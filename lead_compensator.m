...
% lead_compensator: Calculates lead cascade compensator with zero, pole and gain
...
% - mode: Must be either 'zero_first' or 'pole_first'. Determines which
% parameter will be selected by the user and which will be calculated by
% the function.
...
if lead_pole > 0
    warning('Controller pole is positive.')
end
